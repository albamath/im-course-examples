 ...
 */
// initially copied from https://ysulyma.github.io/tools/revolution/OrbitControls.js
...
THREE.OrbitControls = function (object, domElement) {
	...
	function onMouseDown(event) {
		...
		switch (event.button) {
			case event.ctrlKey ? 9999 : scope.mouseButtons.ORBIT:
			...
			case event.ctrlKey ? scope.mouseButtons.ORBIT : 9999:
